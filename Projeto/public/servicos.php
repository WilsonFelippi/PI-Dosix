...
<section class="container-fluid">
    <div class="row justify-content-around align-items-center">
        <div class="col-3">
            <div class="card">
                <img class="card-img-top" src="./assets/images/fisioterapeuta.png" alt="fisioterapeuta">
                <div class="card-body">
        ...
        <div class="col-3">
            <div class="row">
                ...
                <h2>Cuidador</h2>
                <p class="conteudo">Nossos cuidadores são dedicados a oferecer cuidados personalizados e atenção cuidadosa para a terceira idade. Sua empatia e compromisso garantem um tratamento especializado, proporcionando apoio essencial.
                </p>
            </div>
        </div>
        <div class="col-3">
