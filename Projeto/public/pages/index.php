...
<body>
    <form class="form" action="Dados.php" method="post">
       ...
       <div class="input-box">
                ...
                <input type="date" name="dataNascimento" placeholder="Digite seu nascimento" required="">
            </div>


              <div class="input-box">
                    <label>Dia do Agendamento</label>
                 <input type="date" name="diaAgendamento" placeholder="Digite o dia do agendamento" required="">
            </div>
